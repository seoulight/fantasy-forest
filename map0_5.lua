...
function scene:create( event )
	...
	local bg2 = display.newImageRect("image/rainbow/bg3.png", 1280, 720)
	...
	nero.x, nero.y = 70, display.contentHeight * 0.4
	...
	local function color()
		...
		brush1.x, brush1.y = display.contentWidth*0.45, display.contentHeight*0.86
	...
	local function nextScene()
		...
		composer.gotoScene("map0_6", { effect = "fade", time = 900 })
	end
