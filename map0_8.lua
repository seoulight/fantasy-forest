...
function scene:create( event )
	...
	local bg = display.newImageRect("image/rainbow/bg4.png", 1280, 720)
	...
	for i = 1, 6 do
		b1[i] = display.newImageRect(b1Group,"image/rainbow/4-1.png", 100, 100) 
	...
	local b2 = display.newImageRect("image/rainbow/4-2.png", 100, 100) 
	...
	for i = 1, 6 do
		b3[i] = display.newImageRect(b3Group,"image/rainbow/4-4.png", 100, 100) 
	...
	for i = 1, 2 do
		b4[i] = display.newImageRect(b4Group, "image/rainbow/4-3.png", 100, 100) 
	...
	for i = 1, 6 do
		b5[i] = display.newImageRect(b5Group,"image/rainbow/4-4.png", 100, 100) 
	...
	for i = 1, 13  do
		b6[i] = display.newImageRect(b6Group,"image/rainbow/4-5.png", 100, 100) 
	...
	for i = 1, 13  do
		b7[i] = display.newImageRect(b7Group,"image/rainbow/4-6.png", 100, 100) 
