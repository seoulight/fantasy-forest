...
function scene:create( event )
	...
	for i = 1, 2 do
		rose[i] = display.newImageRect(roseGroup, "image/image1_2/rose2.png", 200, 100)
	...
	local function color()
		...
		local function gameStart()
			composer.gotoScene("game1_puzzle")
		end

		-- 장미 아이템 클릭하면 퍼즐 게임 시작 --
		roseGroup:addEventListener("tap", gameStart)
	end

	bg:addEventListener("tap", color)
end
...
>>>>>>> b03b0451573401b8f0db0e5a02f1400fd535a7f0
return scene